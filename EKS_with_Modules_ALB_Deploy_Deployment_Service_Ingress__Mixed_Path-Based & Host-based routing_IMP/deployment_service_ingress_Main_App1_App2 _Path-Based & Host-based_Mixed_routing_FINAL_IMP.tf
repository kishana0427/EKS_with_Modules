  ...
  spec {
    ...
    rule {
      ...
      http {
        ...
        # App1 under /app1 like mrcet.kozow.com/app1 OR main.mrcet.kozow.com/app1
        path {
          path      = "/app1"
          path_type = "Prefix"
          backend {
        ...
        # App2 under /app2 like mrcet.kozow.com/app2 OR main.mrcet.kozow.com/app2
        path {
          path      = "/app2"
          path_type = "Prefix"
          backend {
